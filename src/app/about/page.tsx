import { Palette, Heart, Target, Globe } from 'lucide-react';
      ...
      <div className="container py-16">
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center mb-20">
          <div>
            ...
            <p className="text-[#5A6472] leading-relaxed mb-4">At M13 Design Studio, we believe that art is not just decoration &mdash; it&apos;s an expression of who you are. Whether it&apos;s a custom portrait of your family, a devotional piece for your puja room, or a minimalist print for your workspace, we create art that resonates.</p>
            <p className="text-[#5A6472] leading-relaxed">We work with over 120 skilled artists &mdash; from traditional painters to contemporary digital designers &mdash; ensuring every style, every taste is represented in our collection.</p>
          </div>
          <div className="relative h-80 rounded-3xl overflow-hidden">
            <Image src="https://picsum.photos/seed/about1/700/400" alt="Our workshop" fill className="object-cover" />
